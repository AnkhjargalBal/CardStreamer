...
JNIEXPORT jboolean JNICALL Java_my_exercise_videoprocess_VideoFrameUnit_createStreamingMediaPlayer(JNIEnv* env, jclass clazz, jstring filename)
{
    XAresult res;
...
JNIEXPORT void JNICALL Java_my_exercise_videoprocess_VideoFrameUnit_setPlayingStreamingMediaPlayer(JNIEnv* env, jclass clazz, jboolean isPlaying)
{
    XAresult res;
...
JNIEXPORT void JNICALL Java_my_exercise_videoprocess_VideoFrameUnit_shutdown(JNIEnv* env, jclass clazz)
{
...
// set the surface
JNIEXPORT void JNICALL Java_my_exercise_videoprocess_VideoFrameUnit_setSurface(JNIEnv *env, jclass clazz, jobject surface)
{
...
JNIEXPORT void JNICALL  Java_my_exercise_videoprocess_VideoFrameUnit_rewindStreamingMediaPlayer(JNIEnv *env, jclass clazz)
{
    XAresult res;
